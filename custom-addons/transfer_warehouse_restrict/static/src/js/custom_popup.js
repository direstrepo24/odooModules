odoo.define('pos_warehouse_restrict.CustomWarehousePopup', function (require) {
    ...
    class CustomWarehousePopup extends PosComponent {
        ...
        confirm() {
            ...
            const selectedWarehouse = this.getPayload();
        if (selectedWarehouse) {
            const url = `/web#action=stock.action_picking_tree_all&model=stock.picking&warehouse_id=${selectedWarehouse.warehouse_id}`;
        ...
        cancel() {
            ...
            this.trigger('close-popup', { confirmed: false });
